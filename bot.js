...
const T = {
  ru: {
    ...
    contractMsg:
      ...
      `1️⃣ Фото униформы и внешнего вида\n` +
      `2️⃣ Фото средств и оборудования\n` +
      `3️⃣ Фото ДО уборки\n` +
      `4️⃣ Фото ПОСЛЕ уборки\n` +
  ...
  en: {
    ...
    contractMsg:
      ...
      `1️⃣ Photo of uniform & appearance\n` +
      `2️⃣ Photo of supplies & equipment\n` +
      `3️⃣ Photos BEFORE cleaning\n` +
      `4️⃣ Photos AFTER cleaning\n` +
    ...
    photoExteriorGot: (n) => `📸 Appearance: ${n} photo(s). Send more or continue:`,
  ...
  uz: {
    ...
    contractMsg:
      ...
      `1️⃣ Forma va tashqi ko'rinish suratlari\n` +
      `2️⃣ Jihozlar suratlari\n` +
      `3️⃣ Tozalashdan OLDIN suratlari\n` +
      `4️⃣ Tozalashdan KEYIN suratlari\n` +
    ...
    photoExteriorGot: (n) => `📸 Tashqi ko'rinish: ${n} surat. Yana yuboring yoki davom eting:`,
